...
<div class="aui-product-boutique clearfix">
  ...
  <div class="aui-footer-product-fixed">
    ...
    <div class="aui-footer-product-action-list"> <a href="javascript:;" class="yellow-color" @click="cartadd">加入购物车</a> <a href="javascript:;" class="red-color">立即购买</a> </div>
  </div>
</footer>
            ...
            if(this.goods){
                ...
                for(var i=0;i<this.goods.length;i++){
                    if(this.goods[i].id == this.id){
                        this.goods[i].num =1*this.num.value + 1*this.goods[i].num;
                        onoff = false;
                    }
                }
                if(onoff){
